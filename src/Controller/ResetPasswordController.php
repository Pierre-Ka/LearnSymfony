...
/*
    Lorsque la route est défini avant la classe, elle s'applique a toute la classe :
    request() devient /reset-password
    checkEmail() devient /reset-password/check-email
    reset() devient /reset-password/reset/{token}
 */
class ResetPasswordController extends AbstractController
{
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        try {
            ...
            /*
                Rajoute un message flash pour expliquer ce qui va pas.
             */
